...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?= base_url('assets/template') ?>/images/ico/apple-touch-icon-144-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?= base_url('assets/template') ?>/images/ico/apple-touch-icon-114-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?= base_url('assets/template') ?>/images/ico/apple-touch-icon-72-precomposed.png">
  <link rel="apple-touch-icon-precomposed" href="<?= base_url('assets/template') ?>/images/ico/apple-touch-icon-57-precomposed.png">
</head>
<!--/head-->
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?= base_url() ?>"><img src="<?= base_url('assets/template') ?>/images/home/logo.png" alt="" /></a>
            </div>
